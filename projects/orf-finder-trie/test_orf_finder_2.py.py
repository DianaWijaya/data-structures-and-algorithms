...
if __name__ == "__main__":
    ...
    assert(sorted(genome.find("AAA","BB")) == sorted(['AAABB', 'AAABBB']))
    assert(sorted(genome.find("BB","A")) == sorted([]))
    assert(sorted(genome.find("AA","BC")) == sorted(['AABBBC', 'AAABBBC']))
    assert(sorted(genome.find("A","B")) == sorted(['AAAB', 'AAABB', 'AAABBB', 'AAB', 'AABB', 'AABBB', 'AB', 'ABB', 'ABBB']))
    assert(sorted(genome.find("AA","A")) == sorted(['AAA']))
    assert(sorted(genome.find("AAAB","BBB")) == sorted([]))
