...
class TestTreeMap(unittest.TestCase):
    ...
    def test_example_9(self):
        forest3 = TreeMap([(4, 3, 3), (3, 2, 3), (1, 2, 3)], [(3, 5, 2)])

        start = 4
        exits = [1]

        result = forest3.escape(start, exits)
        
        self.assertEqual(result, None)

    def test_example_6(self):
        forest = TreeMap([(0, 1, 2), (1, 0, 1)], [(0, 3, 1)])
        self.assertEqual(forest.escape(0, [0]), (4, [0, 1, 0]))
        self.assertEqual(forest.escape(0, [0, 1]), (3, [0, 1]))
        self.assertEqual(forest.escape(1, [0]), (5, [1, 0, 1, 0]))
    ...
    def test_last_one(self):
        forest = TreeMap([(1,2,1), (2,3,1), (2,5,100), (3,4,1), (3,5,1), (4,2,1), (4,3,1)], [(3,1,4)])
        self.assertEqual(forest.escape(1, [5]), (5, [1, 2, 3, 4, 3, 5]))
